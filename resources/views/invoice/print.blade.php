            ...
            <table class="table-main">
                <tr>
                    ...
                    <td class="w-30 float-right">
                        <b class="underline">Purchase Invoice </b><br>
                        No: {{ $invoice->number }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="w-70">
                        <table class="w-100 font-10">
                            ...
                            <tr>
                                <td width="100">Good Receipt Number</td>
                                <td width="10">:</td>
                                <td>{{ $invoice->goodreceipt->number }}</td>
                            </tr>
                        </table>
                    </td>
                    <td class="w-30">
        ...
        <td>
            <table class="table-main font-10">
                ...
                <tr class="garis-atas">
                    ...
                    <td class="float-right">{{ Number::format((float) $invoice->total) }}</td>
                </tr>
                <tr>
                    <td class="float-right text-bold" colspan="5">Discount</td>
                    <td class="float-right">{{ Number::format((float) $invoice->discount) }}</td>
                </tr>
                <tr>
                    <td class="float-right text-bold" colspan="5">Total</td>
                    <td class="float-right">{{ Number::format((float) $invoice->after_discount) }}</td>
                </tr>
                <tr>
                    <td class="float-right text-bold" colspan="5">Tax ({{ $systemsetting['tax'] }} %)</td>
                    <td class="float-right">{{ Number::format((float) $invoice->tax) }}</td>
                </tr>
                <tr>
                    <td class="float-right text-bold" colspan="5">Grand Total</td>
                    <td class="float-right">{{ Number::format((float) $invoice->grand_total) }}</td>
                </tr>
            </table>
        </td>
    </tr>
