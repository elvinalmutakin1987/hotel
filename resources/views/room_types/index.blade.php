    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a type="button" class="btn btn-outline-primary mb-3" href="{{ route('room-types.create') }}"> Add New </a>

                <input type="text" id="search" name="search" class="form-control mb-3" placeholder="Search staff..."
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="link-primary link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover me-2"
                                            href="{{ route('room-types.edit', $d->id) }}">
                                            Edit
                                        </a>
                                        <form class="d-inline" action="{{ route('room-types.destroy', $d->id) }}"
                ...
                <nav>
                    {{ $room_type->links('pagination::bootstrap-5') }}
                </nav>
...
@push('javascript')
    <script>
        ...
        function search() {
            var url = '{{ route('room-types.index', ['search' => '_search']) }}'
