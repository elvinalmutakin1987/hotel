    ...
    <div class="content">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-3 bg-body-tertiary rounded-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $purchase->number }}</li>
            </ol>
        </nav>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="supplier_id" name="supplier_id"
                                    ...
                                    @foreach ($supplier as $d)
                                        <option value="{{ $d->id }}"
                                            {{ $d->id == request()->get('supplier_id') || $d->id == $purchase->supplier_id ? 'selected' : '' }}>
                                            {{ $d->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="date" name="date"
                                    value="{{ $purchase->date ? \Carbon\Carbon::parse($purchase->date)->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="grand_total"
                                        name="grand_total"
                                        value="{{ Illuminate\Support\Number::format((float) $purchase->grand_total) }}"
                                        readonly>
                                </div>
                            </div>
                        </div>
