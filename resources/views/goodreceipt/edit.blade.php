...
@section('content')
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('goodreceipt.update', $goodreceipt->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="supplier_id" name="supplier_id"
                                    ...
                                    @foreach ($supplier as $d)
                                        <option value="{{ $d->id }}"
                                            {{ $d->id == request()->get('supplier_id') || $d->id == $goodreceipt->supplier_id ? 'selected' : '' }}>
                                            {{ $d->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="purchase_id" name="purchase_id"
                                    ...
                                    @if ($goodreceipt->purchase->number !== null)
                                        <option value="{{ $goodreceipt->purchase_id }}">{{ $goodreceipt->purchase->number }}
                                        </option>
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="total" name="total"
                                        readonly
                                        value=" {{ Illuminate\Support\Number::format((float) $goodreceipt->total) }}">
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="discount" name="discount"
                                        value=" {{ Illuminate\Support\Number::format((float) $goodreceipt->discount) }}">
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="after_discount"
                                        ...
                                        value=" {{ Illuminate\Support\Number::format((float) $goodreceipt->after_discount) }}">
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="tax" name="tax"
                                        readonly
                                        value=" {{ Illuminate\Support\Number::format((float) $goodreceipt->tax) }}">
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-6 fw-bold text-end">
                                    <input type="text" class="form-control text-end" id="grand_total"
                                        name="grand_total"
                                        value=" {{ Illuminate\Support\Number::format((float) $goodreceipt->grand_total) }}">
                                </div>
                            </div>
                        </div>
                    </div>
