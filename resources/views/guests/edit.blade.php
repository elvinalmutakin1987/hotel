                ...
                <form action="{{ route('guests.update', $guest->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('id_card_number') is-invalid @enderror"
                            id="id_card_number" name="id_card_number" value="{{ $guest->id_card_number }}">
                    ...
                    <a type="button" class="btn btn-secondary" href="{{ route('guests.index') }}">Back</a>
                </form>
            </div>
        </div>
    </div>
