    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a type="button" class="btn btn-outline-primary mb-3" href="{{ route('staff.create') }}"> Add New </a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="link-primary link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover me-2"
                                            href="{{ route('staff.edit', $d->id) }}">
                                            Edit
                                        </a>
                                        <form class="d-inline" action="{{ route('staff.destroy', $d->id) }}" method="POST"
                                            id="form-delete{{ $d->id }}">
                                            @csrf
                                            @method('DELETE')
...
@push('javascript')
    <script>
        ...
        function search() {
            var url = '{{ route('staff.index', ['search' => '_search']) }}'
