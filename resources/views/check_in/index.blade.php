    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a type="button" class="btn btn-outline-primary mb-3" href="{{ route('checkin.create') }}"> Add New </a>
                ...
                <table id="table1" class="table table-striped mt-3">
                    <thead class="table-group-divider">
                        <tr>
                            ...
                            <th class="w-25 text-center">Check In Time</th>
                        </tr>
                    </thead>
...
@push('javascript')
    <script>
        ...
        function search() {
            var url = '{{ route('checkin.index', ['date' => '_date']) }}'
